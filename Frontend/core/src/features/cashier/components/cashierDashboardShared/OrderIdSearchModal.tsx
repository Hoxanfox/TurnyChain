      ...
      <div className="bg-white w-full sm:max-w-md sm:rounded-2xl rounded-t-2xl shadow-2xl border border-indigo-100">
        <div className="bg-gradient-to-r from-indigo-600 to-blue-600 text-white p-4 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-lg font-bold">Buscar Comanda por ID</h2>
              <p className="text-xs text-indigo-100">Encuentra una comanda o grupo completo</p>
            </div>
            <button
              onClick={onClose}
              className="p-2 hover:bg-white hover:bg-opacity-20 rounded-full transition-colors"
              aria-label="Cerrar buscador por ID"
            >
              ✕
            </button>
          </div>
        ...
        <div className="p-4">
          ...
          <p className="mt-2 text-xs text-gray-500">
            Si coincide comanda padre o hija, se mostrarán todas las comandas asociadas.
          </p>
        </div>
