...
export const CashierMobileError: React.FC<CashierMobileErrorProps> = ({ onRetry }) => (
  <div className="flex items-center justify-center py-20">
    <div className="text-center">
      <div className="text-red-600 text-6xl mb-4">⚠️</div>
      <p className="text-red-600 font-semibold text-lg">Error al cargar las ordenes</p>
      <p className="text-gray-500 text-sm mt-1">Verifica tu conexion o intenta nuevamente</p>
      {onRetry && (
        <button
          onClick={onRetry}
