...
import InventoryReceiptHistoryPage from './features/inventory/InventoryReceiptHistoryPage';
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/inventory/receipts/history" element={<ProtectedRoute user={user}><InventoryReceiptHistoryPage /></ProtectedRoute>} />
